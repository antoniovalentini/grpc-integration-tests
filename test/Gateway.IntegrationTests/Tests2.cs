...
public class Tests2 : TestBaseSetup
{
    private readonly ITestOutputHelper _output;

    public Tests2(GrpcTestFixture<Startup> fixture, ITestOutputHelper output) : base(fixture)
    {
        _output = output;
    }
    ...
    {
        // Arrange
        var expected = $"Test2 Extra Service {number}";
