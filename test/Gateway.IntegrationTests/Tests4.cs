...
public class Tests4 : TestBaseSetup
{
    private readonly ITestOutputHelper _output;

    public Tests4(GrpcTestFixture<Startup> fixture, ITestOutputHelper output) : base(fixture)
    {
        _output = output;
    }
    ...
    {
        // Arrange
        var expected = $"Test4 Extra Service {number}";
